...
package de.Keyle.MyPet.compat.nms.util.iconmenu;

import de.Keyle.MyPet.api.gui.IconMenu;
import de.Keyle.MyPet.api.gui.IconMenuItem;
import de.Keyle.MyPet.api.util.Compat;
import de.Keyle.MyPet.api.util.ReflectionUtil;
import de.Keyle.MyPet.compat.nms.util.inventory.CustomInventory;
...
public class IconMenuInventory implements de.Keyle.MyPet.api.gui.IconMenuInventory {
    ...
    static {
        try {
            Class<?> craftMetaItemClass = Class.forName("org.bukkit.craftbukkit.inventory.CraftMetaItem");
