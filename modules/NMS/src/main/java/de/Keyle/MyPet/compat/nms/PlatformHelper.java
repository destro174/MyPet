...
package de.Keyle.MyPet.compat.nms;
...
import de.Keyle.MyPet.compat.nms.entity.EntityMyAquaticPet;
import de.Keyle.MyPet.compat.nms.util.inventory.ItemStackNBTConverter;
...
//            ((net.minecraft.world.entity.LivingEntity) entity).addAdditionalSaveData(vanillaNBT);
            vanillaNBT = NbtPredicate.getEntityTagToCompare(entity);
        } else {
    ...
    public void applyTagToEntity(TagCompound tag, Entity bukkitEntity) {
        ...
        if (vanillaNBT != null) {
            if (bukkitEntity instanceof Villager) {
                ...
                //FIXME
//                NbtPredicate.getEntityTagToCompare(villager);
